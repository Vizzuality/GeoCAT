		...
		DeleteInfowindow.prototype.draw = function() {
		  ...
		  if (!div) {
		    ...
		    div.style.paddingLeft = "0px";
				...
				div.style.background = 'url(/assets/editor/delete_bkg.png) no-repeat 0 0';
		    ...
		    delete_button.style.position = "absolute";
				...
				delete_button.style.background = 'url(/assets/editor/yes_delete_button.png) no-repeat 0 0';
